...
DATA_BACKEND = str(get_secret("DATA_BACKEND", "supabase")).lower()  # supabase | sqlite
...
def backup_export_filename() -> str:
    return "asegura_vida_supabase_backup.json" if is_supabase_enabled() else "asegura_vida_app.db"
